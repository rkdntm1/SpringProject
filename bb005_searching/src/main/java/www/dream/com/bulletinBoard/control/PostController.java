...
public class PostController {
	...
	public String modifyPost(@RequestParam("boardId") int boardId, PostVO modifiedPost, PostCriteria fromUser, RedirectAttributes rttr) {
	...
	public String removePost(@RequestParam("boardId") int boardId, 
			@RequestParam("postId") String id, PostCriteria fromUser, RedirectAttributes rttr) {
