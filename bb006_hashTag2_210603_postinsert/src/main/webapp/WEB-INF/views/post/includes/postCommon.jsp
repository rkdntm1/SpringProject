...
<div class="form-group">
	<label>내용</label>
	<textarea id="txaContent" name="content" class="form-control" row="3" readonly>${post.content}</textarea>
</div>
...
<div class="form-group">
	<p>조회수 <b>${post.readCnt}</b> 좋아요수 <i>${post.likeCnt}</i> 싫어요수 <strong>${post.dislikeCnt}</strong></p>
</div>
