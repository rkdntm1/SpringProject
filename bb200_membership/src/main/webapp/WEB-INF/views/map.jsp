...
<head>
    ...
    <title>카카오 맵 응용</title>
    <script type="text/javascript"
        src="//dapi.kakao.com/v2/maps/sdk.js?appkey=fc84bb357e689489432517c4afd4cbda&libraries=services,clusterer,drawing"></script>
...
<body>
    ...
    <div class="container">
                ...
                <div class="option">
                    <div>
                        <form onsubmit="searchPlaces(); return false;">
                            키워드 : <input type="text" value="가산동 맛집" id="keyword" size="15">
        ...
        <h4>검색 결과 마커 클릭 시, 현재 위치 좌표를 도로명 or 법정동 주소로 변환하여 길찾기 호출</h4>
        <h4>주소 변환 API 응답이 느려 로딩 레이어 필요함.</h4>
        <script>
